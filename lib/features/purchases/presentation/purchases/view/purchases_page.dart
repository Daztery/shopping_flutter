            ...
            IconButton(
              ...
              onPressed: () async {
                ...
                final limit = await showDialog<double?>(
                  context: context,
                  builder: (_) => AlertDialog(
                    title: const Text('Definir límite de gasto'),
                    content: TextField(
                      controller: controller,
                      keyboardType:
                          const TextInputType.numberWithOptions(decimal: true),
                      decoration:
                          const InputDecoration(labelText: 'Monto (S/.)'),
                    ),
                    actions: [
                      TextButton(
                ...
                if (limit != null) {
                  final value = limit == 0.0 ? null : limit;
                  context.read<PurchaseBloc>().add(SetSpendingLimit(value));
                }
              },
            ),
            IconButton(
            ...
            child: Column(
              children: [
                BlocBuilder<PurchaseBloc, PurchaseState>(
                  buildWhen: (p, n) =>
                      p.spendingLimit != n.spendingLimit ||
                      p.isOverLimit != n.isOverLimit ||
                        ...
                        itemBuilder: (_, i) {
                          ...
                          return Dismissible(
                            ...
                            background: Container(
                              color: const Color.fromARGB(255, 245, 81, 69),
